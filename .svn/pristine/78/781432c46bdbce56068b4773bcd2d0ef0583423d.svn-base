    ...
    $.MvcSheetUI.Controls.SheetTextBox.Inherit($.MvcSheetUI.IControl, {
        ...
        _createPopup: function () {
            ...
            if (this.PopupWindow == "PopupWindow") { //弹窗模式
                ...
                // var w = that.OutputMappings.split(',').length*100+"px";
                ...
                popupDiv += "<div class='modal-dialog' style='width:" + w + "; min-width: 700px;max-width: 1000px'>";
                popupDiv += "<div class='modal-content' style='width:" + w + "; min-width: 700px;max-width: 1000px''>";
