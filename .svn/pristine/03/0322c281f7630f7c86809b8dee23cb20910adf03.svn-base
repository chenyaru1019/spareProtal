...
<asp:Content ID="master" ContentPlaceHolderID="masterContent" runat="Server">
    ...
    <div style="text-align: center;" class="DragContainer">
        <label id="lblTitle" class="panel-title">合同文件归档子流程</label>
    </div>
    <div class="panel-body sheetContainer">
            ...
            <div class="divContent" id="divSheet">
                ...
                <div class="row">
                    ...
                    <div id="control13" class="col-md-10">
                        <input type="text" data-datafield="ContractFileSignVer" data-type="SheetTextBox" id="" class="hidden" style="">
                        <div id="ContractFileSignVer"></div>
                    </div>
                </div>
                <div class="row HYDiv">
                    ...
                    <div id="control15" class="col-md-10">
                        <input type="text" data-datafield="AgencyFileSignVer" data-type="SheetTextBox" id="" class="hidden" style="">
                        <div id="AgencyFileSignVer"></div>
                    </div>
                </div>
        ...
        <div class="ContractContent ContractContentGetBack">
            <div class="nav-icon fa  fa-chevron-right bannerTitle bannerTitleGetBack">
                <label id="divSheetInfo" data-en_us="Sheet information">合同文件归档回退记录&nbsp;<span class="ContractNoShow"></span></label>
                <span class="pull-right text-muted" id="toggleBtn">
                    <i class="fa fa-fw fa-angle-double-down text" style="display:none"></i>
                    <i class="fa fa-fw  fa-angle-double-up text-active" style="display: block;"></i>
                </span>
            ...
            <div class="divContent divContent_Tab" id="divSheet">
                <div class="row">
                    <div id="div371959" class="col-md-2">
                        <label data-datafield="GetBackGDTbl" data-type="SheetLabel" id="ctl280690" class="" style="">合同文件归档回退记录</label>
                    </div>
                    <div id="div666980" class="col-md-10">
                        <table id="ctl532792" data-datafield="GetBackGDTbl" data-type="SheetGridView" class="SheetGridView" style="" data-displayadd="false" data-displaydelete="false" data-defaultrowcount="0" data-displaysequenceno="false" data-displaysummary="false">
                            <tbody>
                                <tr class="header">
                                    <td id="ctl532792_SerialNo" class="rowSerialNo">序号</td>
                                    <td id="ctl532792_header0" data-datafield="GetBackGDTbl.Approver" style="">
                                        <label id="ctl532792_Label0" data-datafield="GetBackGDTbl.Approver" data-type="SheetLabel" style="">申请人</label></td>
                                    <td id="ctl532792_header1" data-datafield="GetBackGDTbl.ApproveDate" style="">
                                        <label id="ctl532792_Label1" data-datafield="GetBackGDTbl.ApproveDate" data-type="SheetLabel" style="">申请时间</label></td>
                                    <td id="ctl532792_header2" data-datafield="GetBackGDTbl.Remark" style="">
                                        <label id="ctl532792_Label2" data-datafield="GetBackGDTbl.Remark" data-type="SheetLabel" style="">回退事由</label></td>
                                    <td id="ctl532792_header3" data-datafield="GetBackGDTbl.OldInstanceActivityName" style="">
                                        <label id="ctl532792_Label3" data-datafield="GetBackGDTbl.OldInstanceActivityName" data-type="SheetLabel" style="">当前阶段</label></td>
                                    <td id="ctl532792_header4" data-datafield="GetBackGDTbl.InstanceActivityName" style="">
                                        <label id="ctl532792_Label4" data-datafield="GetBackGDTbl.InstanceActivityName" data-type="SheetLabel" style="">回退到</label></td>
                                    <td id="ctl532792_header5" data-datafield="GetBackGDTbl.Status" style="">
                                        <label id="ctl532792_Label5" data-datafield="GetBackGDTbl.Status" data-type="SheetLabel" style="">状态</label></td>
                                    <td id="ctl532792_header6" data-datafield="GetBackGDTbl.Operate" style="">
                                        <label id="ctl532792_Label6" data-datafield="GetBackGDTbl.Operate" data-type="SheetLabel" style="">操作</label></td>
                                    <td id="ctl532792_header7" data-datafield="GetBackGDTbl.WorkItemId" style="" class="hidden">
                                        <label id="ctl532792_Label7" data-datafield="GetBackGDTbl.WorkItemId" data-type="SheetLabel" style="">流程节点Id</label></td>
                                    <td class="rowOption hidden">删除</td>
                                </tr>
                                <tr class="template">
                                    <td></td>
                                    <td id="ctl532792_control0" data-datafield="GetBackGDTbl.Approver" style="">
                                        <input type="text" data-datafield="GetBackGDTbl.Approver" data-type="SheetTextBox" id="ctl532792_control0" style=""></td>
                                    <td id="ctl532792_control1" data-datafield="GetBackGDTbl.ApproveDate" style="">
                                        <input type="text" data-datafield="GetBackGDTbl.ApproveDate" data-type="SheetTextBox" id="ctl532792_control1" style=""></td>
                                    <td id="ctl532792_control2" data-datafield="GetBackGDTbl.Remark" style="">
                                        <input type="text" data-datafield="GetBackGDTbl.Remark" data-type="SheetTextBox" id="ctl532792_control2" style=""></td>
                                    <td id="ctl532792_control3" data-datafield="GetBackGDTbl.OldInstanceActivityName" style="">
                                        <input type="text" data-datafield="GetBackGDTbl.OldInstanceActivityName" data-type="SheetTextBox" id="ctl532792_control3" style=""></td>
                                    <td id="ctl532792_control4" data-datafield="GetBackGDTbl.InstanceActivityName" style="">
                                        <input type="text" data-datafield="GetBackGDTbl.InstanceActivityName" data-type="SheetTextBox" id="ctl532792_control4" style=""></td>
                                    <td id="ctl532792_control5" data-datafield="GetBackGDTbl.Status" style="">
                                        <input type="text" data-datafield="GetBackGDTbl.Status" data-type="SheetTextBox" id="ctl532792_control5" style=""></td>
                                    <td id="ctl532792_control6" data-datafield="GetBackGDTbl.Operate" style="">
                                        <a class="btn btn-primary viewBack" onclick="viewBack(this)">查看</a></td>
                                    <td id="ctl532792_control7" data-datafield="GetBackGDTbl.WorkItemId" style="" class="hidden">
                                        <input type="text" data-datafield="GetBackGDTbl.WorkItemId" data-type="SheetTextBox" id="ctl532792_control7" style=""></td>
