...
{
    public partial class DHMy : OThinker.H3.Controllers.MvcPage 
    {
        ...
        public override MvcViewContext LoadDataFields()
        {
            ...
            if (dt_back.Rows.Count > 0)
            {
                ...
                {
                    BizObjectSchema childSchema = this.ActionContext.Schema.GetProperty("GetBackDHTbl").ChildSchema;
                    // 第一行
                ...
                this.ActionContext.InstanceData["GetBackDHTbl"].Value = bizObjects;
            }
