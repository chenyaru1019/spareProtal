    ...
    $.MvcSheetUI.Controls.SheetAssociation.Inherit($.MvcSheetUI.IControl, {
        ...
        Render: function () {
            ...
            if (this.IsMobile) {
                ...
                $(this.Element).wrap("<a href='" + linkUrl + "' target='_blank'></a>");
                this._createPopup();
            }
        },
        GetLinkUrl: function () {
        ...
        SetValue: function (v) {
            ...
            if (this.LinkMode != "None" && !this.IsMobile) {
                var linkUrl = this.GetLinkUrl();
                $(this.Element).parent().attr("href", linkUrl);
                $(this.Element).parent().attr("target", "_blank");
            }
            $(this.Element).val(v);
            $(this.Element).change();
            if (this.FormatRule) {
            ...
            if (v) {
                ...
                if (val != "") {
                    ...
                    $(strs).each(function (i) {
                        ...
                        lbl.append($("<a href='" + linkUrl + "' target='_blank'><span></span></a>").text(this.toString()));
                    });
                }
