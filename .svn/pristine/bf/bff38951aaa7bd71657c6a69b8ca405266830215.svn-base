...
{
    public partial class GDChangeMy : OThinker.H3.Controllers.MvcPage 
    {
        ...
        public override MvcViewContext LoadDataFields()
        {
            ...
            if (dt_back.Rows.Count > 0)
            {
                ...
                {
                    BizObjectSchema childSchema = this.ActionContext.Schema.GetProperty("GetBackGDChangeTbl").ChildSchema;
                    // 第一行
                ...
                this.ActionContext.InstanceData["GetBackGDChangeTbl"].Value = bizObjects;
            }
