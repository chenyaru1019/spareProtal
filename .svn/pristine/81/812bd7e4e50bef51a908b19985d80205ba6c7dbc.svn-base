...
{
    public partial class BatchDK_DKMy : OThinker.H3.Controllers.MvcPage 
    {
        ...
        public override MvcViewContext LoadDataFields()
        {
            ...
            if (dt_back.Rows.Count > 0)
            {
                ...
                {
                    BizObjectSchema childSchema = this.ActionContext.Schema.GetProperty("GetBackBatchDKTbl").ChildSchema;
                    // 第一行
                ...
                this.ActionContext.InstanceData["GetBackBatchDKTbl"].Value = bizObjects;
            }
