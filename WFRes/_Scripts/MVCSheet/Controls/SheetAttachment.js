            ...
            var hideSheet = $.MvcSheetUI.IonicFramework.$ionicActionSheet.show({
                ...
                buttonClicked: function (index, button) {
                    ...
                    if (button.code == "download") {
                        ...
                        else if ($.MvcSheetUI.IonicFramework.$rootScope.loginfrom == "app"
                            || $.MvcSheetUI.IonicFramework.$rootScope.loginfrom == "wechat") {
                            var u = navigator.userAgent;
                            ...
                            if (ios) {
                                ...
                                $.ajax({
                                    ...
                                    success: function (data) {
                                        var Browse_Extension = ".jpg,.gif,.jpeg,.png,.txt,.mp3";
                                        if (Browse_Extension.indexOf(data.Extension) > -1) {
                                            $.MvcSheetUI.IonicFramework.$rootScope.AttachmentUrl = url + data.Url;
