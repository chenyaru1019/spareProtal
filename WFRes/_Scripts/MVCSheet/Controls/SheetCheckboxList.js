    ...
    $.MvcSheetUI.Controls.SheetCheckboxList.Inherit($.MvcSheetUI.IControl, {
        ...
        MobileInit: function () {
            ...
            if (this.Editable) {
                ...
                $(this.Element).parent().bind("click.MobileCheckListBox", function () {
                    ionic.$ionicModal.fromTemplateUrl('checkbox_autocomplete.html', {
                        scope: ionic.$scope
                    }).then(function (modal) {
                        ionic.$scope.modal = modal;
                        ionic.$scope.CheckListDisplay = that.CheckListDisplay;
                        ionic.$scope.modal.show();
                        ionic.$scope.clickCheckList = function () {
