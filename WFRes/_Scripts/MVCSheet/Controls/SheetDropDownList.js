        ...
        ionicInit: function (ionic) {
            ...
            $(this.Element.parentElement).unbind('click.showChoice').bind('click.showChoice', function (e) {
                ionic.$ionicModal.fromTemplateUrl('radio_autocomplete.html', {
                    ...
                    ionic.$scope.RadioListDisplay = [];

                    if (that.DisplayEmptyItem) {
                        var emptyOption = {
                            DataField: that.DataField,
                            Value: "",
                            Text: that.EmptyItemText
                        };
                        ionic.$scope.RadioListDisplay.push(emptyOption);
                    }
                    ionic.$scope.RadioListDisplay = ionic.$scope.RadioListDisplay.concat(that.MobileOptions);
