...
Sheet.Validate.prototype = {
    init: function () {
        ...
        if (!this.sheet.container) {
            this.sheet.container = $("input[" + this.AttrName + "],textarea[" + this.AttrName + "],select[" + this.AttrName + "]");
        }
        else {
            this.sheet.container = $(this.sheet.container.context).find("input[" + this.AttrName + "],textarea[" + this.AttrName + "],select[" + this.AttrName + "]");
        }
