...
ReportWidgetSimpleBoard.prototype = {
    ...
    draw: function (data) {
        ...
        //添加显示的值
        var $columnName = $('<p class="simpleboardcolumnname"></p>').attr('data-name', data.Text).attr('data-code', data.ColumnCode).append('<span >' + data.Text + '</sapn>').append('<input type="textbox" class="simpleboardtextinput"  maxlength=6></input>');
