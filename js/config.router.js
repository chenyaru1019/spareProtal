  ...
  .config(
    ['$stateProvider', '$urlRouterProvider',
      function ($stateProvider, $urlRouterProvider) {
          ...
          */
		  //我的协议
              .state('app.My_agreement', {
                  url: '/My_agreement',
                  //controller: 'My_agreementController',
                  templateUrl: '/Portal/Sheets/Agreement/My_agreement/index.html',
                  resolve: {
                      deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                          return $ocLazyLoad.load([
                              '/Portal/Sheets/Agreement/My_agreement/My_agreement.js',
                              'vendor/Datatable/jquery.dataTables.js',
              ...
              //协议查询
              .state('app.Agreement_query', {
                  url: '/Agreement_query',
                  //controller: 'My_agreementController',
                  templateUrl: '/Portal/Sheets/Agreement/Agreement_query/index.html',
                  resolve: {
                      deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                          return $ocLazyLoad.load([
                              '/Portal/Sheets/Agreement/Agreement_query/Agreement_query.js',
                              'vendor/Datatable/jquery.dataTables.js',
                              'vendor/Datatable/jquery.dataTables.css',
                          ])
                      }]
              ...
              //我的合同
              .state('app.my_contraot', {
                  url: '/my_contraot',
                  //controller: 'My_agreementController',
                  templateUrl: '/Portal/Sheets/Agreement/Mycontract/index.html',
                  resolve: {
                      deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                          return $ocLazyLoad.load([
                              '/Portal/Sheets/Agreement/Mycontract/Mycontract.js',
                              'vendor/Datatable/jquery.dataTables.js',
                              'vendor/Datatable/jquery.dataTables.css',
                          ])
                      }]
              ...
              //合同查询
              .state('app.Contract_query', {
                  url: '/Contract_query',
                  //controller: 'My_agreementController',
                  templateUrl: '/Portal/Sheets/Agreement/Contract_query/index.html',
                  resolve: {
                      deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                          return $ocLazyLoad.load([
                              '/Portal/Sheets/Agreement/Contract_query/Contract_query.js',
                              'vendor/Datatable/jquery.dataTables.js',
                              'vendor/Datatable/jquery.dataTables.css',
                          ])
                      }]
              ...
              //我的项目
              .state('app.My_project', {
                  url: '/My_project',
                  //controller: 'My_agreementController',
                  templateUrl: '/Portal/Sheets/Agreement/My_project/index.html',
                  resolve: {
                      deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                          return $ocLazyLoad.load([
                              '/Portal/Sheets/Agreement/My_project/My_project.js',
                              'vendor/Datatable/jquery.dataTables.js',
                              'vendor/Datatable/jquery.dataTables.css',
                          ])
                      }]
              ...
              //项目查询
              .state('app.Project_query', {
                  url: '/Project_query',
                  //controller: 'My_agreementController',
                  templateUrl: '/Portal/Sheets/Agreement/Project_query/index.html',
                  resolve: {
                      deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                          return $ocLazyLoad.load([
                              '/Portal/Sheets/Agreement/Project_query/Project_query.js',
                              'vendor/Datatable/jquery.dataTables.js',
                              'vendor/Datatable/jquery.dataTables.css',
                          ])
                      }]
