<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SStaffProbationaryPeriodQuery.aspx.cs" Inherits="OThinker.H3.Portal.Sheets.DefaultEngine.SStaffProbationaryPeriodQuery" EnableEventValidation="false" MasterPageFile="~/MvcSheet.master" %>
...
<div style="text-align: center;" class="DragContainer">
	<label id="lblTitle" class="panel-title">员工试用期转正查询</label>
</div>
    <div class="panel-body sheetContainer">
		...
		<div class="divContent" id="divSheet">
			<div class="row">
				...
				<div id="control2" class="col-md-4">
					<select data-datafield="Organization" data-type="SheetDropDownList" id="ctl588326" class="" style="" data-schemacode="SelectAllOrgName" data-querycode="SelectAllOrgName" data-datavaluefield="Name1" data-datatextfield="Name1" data-displayemptyitem="true" data-emptyitemtext="全部">
					</select>
				</div>
			</div>
			<div class="row">
                ...
                <div id="div30546" class="col-md-1 rightBtn">
                    <input id="StaffProbationaryPeriodQueryId" type="button" style="padding:3px 10px" onclick="StaffProbationaryPeriodQuery()" class="btn btn-primary" value="查找" />
                </div>
			</div>
		 <!-- 分割线 -->
                ...
                <div class="myTable">
                    <table data-toggle="table" class="table table-striped table-bordered table-hover" id="table_StaffProbationaryPeriodQuery"></table>
                </div>
     ...
     <script src="SStaffProbationaryPeriodQuery.js"></script>
</asp:Content>