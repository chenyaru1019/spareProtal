...
{
    public partial class BatchJS_QKMy : OThinker.H3.Controllers.MvcPage 
    {
        ...
        public override MvcViewContext LoadDataFields()
        {
            ...
            if (dt_back.Rows.Count > 0)
            {
                ...
                {
                    BizObjectSchema childSchema = this.ActionContext.Schema.GetProperty("GetBackBatchQKTbl").ChildSchema;
                    // 第一行
                ...
                this.ActionContext.InstanceData["GetBackBatchQKTbl"].Value = bizObjects;
            }
