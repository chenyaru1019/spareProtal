...
{
    public partial class PaymentUpdateMy : OThinker.H3.Controllers.MvcPage 
    {
        ...
        public override MvcViewContext LoadDataFields()
        {
            ...
            if (dt_back.Rows.Count > 0)
            {
                ...
                {
                    BizObjectSchema childSchema = this.ActionContext.Schema.GetProperty("GetBackPaymentUpdateSubTbl").ChildSchema;
                    // 第一行
                ...
                this.ActionContext.InstanceData["GetBackPaymentUpdateSubTbl"].Value = bizObjects;
            }
