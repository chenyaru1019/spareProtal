...
{
    public partial class ImportLicenseMy : OThinker.H3.Controllers.MvcPage 
    {
        ...
        public override MvcViewContext LoadDataFields()
        {
            ...
            if (dt_back.Rows.Count > 0)
            {
                ...
                {
                    BizObjectSchema childSchema = this.ActionContext.Schema.GetProperty("GetBackImportLicenseSubTbl").ChildSchema;
                    // 第一行
                ...
                this.ActionContext.InstanceData["GetBackImportLicenseSubTbl"].Value = bizObjects;
            }
