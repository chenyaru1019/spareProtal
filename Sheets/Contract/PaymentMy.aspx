        ...
        <div class="ContractContent" style="margin-top: 15px">
            ...
            <div class="row BankConfirm">
                ...
                <div id="control9" class="col-md-10">
                    <div id="Control21" data-datafield="BankRemark" data-type="SheetComment" style="">
                    </div>
                </div>
            </div>
            ...
            <div class="row tableContent PaymentApprove">
                <div id="title15" class="col-md-2">
                    <span id="Label20" data-type="SheetLabel" data-datafield="ApproveRemark2" class="" style="">信用证申请备注</span>
                </div>
                <div id="control15" class="col-md-10">
                    <div id="Control21" data-datafield="ApproveRemark2" data-type="SheetComment" style="">
                    </div>
                </div>
            </div>
