		...
		<div class="divContent" id="divSheet">
            ...
            <div class="row">
				<div id="title9" class="col-md-2">
					<span id="Label19" data-type="SheetLabel" data-datafield="BGSignDate" style="">变更签约开始日期</span>
				</div>
				<div id="control9" class="col-md-4">
					<input id="BGSignDate" type="text" data-datafield="BGSignDate" data-type="SheetTime" style="" data-defaultvalue="" onFocus="WdatePicker({ dateFmt: 'yyyy-MM-dd', minDate: '2010-01-01', maxDate: '#F{$dp.$D(\'BGSignDate2\')}' })">
				</div>
				<div id="title10" class="col-md-2">
					<span id="Label10" data-type="SheetLabel" data-datafield="BGSignDate2" style="">变更签约结束日期</span>
				</div>
				<div id="control0" class="col-md-4">
					<input id="BGSignDate2" type="text" data-datafield="BGSignDate2" data-type="SheetTime" class="" style="" data-defaultvalue="" onFocus="WdatePicker({ dateFmt: 'yyyy-MM-dd', minDate: '#F{$dp.$D(\'BGSignDate\')}', maxDate: '2050-12-31' } )">
				</div>
			</div>
			...
			<div class="row">
				...
				<div id="control7" class="col-md-4">
					<select data-datafield="Contract_nature" data-type="SheetDropDownList" id="ctl179458" class="" style="" data-masterdatacategory="合同性质（GN/JK）" data-displayemptyitem="true">
					</select>
				</div>
            ...
            <div id="div30546" class="col-md-12 rightBtn" style="text-align: center;">
                    <input id="div30547" type="button" style="padding:3px 10px" onclick="sel_agreement()" class="btn btn-primary" value="查找" />
                </div>
            <div class="myTable">
